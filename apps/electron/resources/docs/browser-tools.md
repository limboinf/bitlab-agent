...
Use `browser_tool` to control built-in browser windows (Chromium) inside Bitlab.
...
- Before first browser tool usage, the agent must read this guide (`~/.bitlab/docs/browser-tools.md`).
