 ...
 * limboinf/bitlab-agent and configured by electron-builder's app-update.yml.
 *
 * Platform behavior:
...
import { getAppVersion } from '@bitlab/shared/version'
import {
...
const AUTO_UPDATE_ENABLED = process.env.BITLAB_AUTO_UPDATE_ENABLED !== 'false'
const AUTO_UPDATE_DISABLED_MESSAGE = 'Automatic updates are unavailable for unsigned macOS builds. Download the latest release from https://github.com/limboinf/bitlab-agent/releases/latest.'
