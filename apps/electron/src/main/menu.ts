...
import { i18n } from '@bitlab/shared/i18n'
 ...
 * Includes only relevant items for the Bitlab app.
 *
...
export async function rebuildMenu(): Promise<void> {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    ...(isMac ? [{
      label: 'Bitlab',
      submenu: [
        { role: 'about' as const, label: i18n.t('menu.aboutApp') },
        updateMenuItem,
      ...
      submenu: [
        {
          ...
          click: () => shell.openExternal('https://github.com/limboinf/bitlab-agent/tree/main/docs')
        },
        {
