...
import { parsePermissionMode } from '@bitlab/shared/agent/mode-types'
        ...
        case 'new-session': {
          ...
          if (parsed.params.input) {
            ...
            if (shouldSend) {
              ...
              // Queue focus immediately so a newly-mounted input can pick it up
              // after the session-switch race. After the draft lands, also fire
              // insert-text so the caret ends up after the prefilled mention chip.
              dispatchFocusInputEvent({ sessionId: session.id })
              setTimeout(() => {
