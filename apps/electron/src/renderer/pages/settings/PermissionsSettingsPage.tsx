 ...
 * Shows both default patterns (from ~/.bitlab/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.bitlab/permissions/default.json.
...
import { type PermissionsConfigFile } from '@bitlab/shared/agent/modes'
import {
                  ...
                  <SettingsSection
                    ...
                    action={
                      (() => {
                        ...
                        const { context, example, displayLabel } = getEditConfig('workspace-permissions', activeWorkspace?.dataRoot || '')
                        return (
                          <EditPopover
                            trigger={<EditButton />}
                            example={example}
                            ...
                            secondaryAction={activeWorkspace ? {
                              label: t("common.editFile"),
                              filePath: `${activeWorkspace.dataRoot}/permissions.json`,
                            } : undefined}
                          />
                        )
                      })()
