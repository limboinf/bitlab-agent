...
/**
 * Thinking delta event - streaming reasoning content
 */
...
/**
 * Thinking complete event - finalizes a reasoning block
 */
...
export interface CompleteEvent {
   ...
   * turns (`BITLAB_KEEP_BG_AGENTS_ALIVE`). When set, the turn ending does NOT tear
