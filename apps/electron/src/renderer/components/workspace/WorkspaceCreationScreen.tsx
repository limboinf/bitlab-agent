...
import { FullscreenOverlayBase } from "@bitlab/ui"
 ...
 *
 * The switcher chooses the action up front, so this overlay opens directly on
 * either the create-project or open-folder form.
 */
