...
import { getSessionSafeAllowedToolNames } from '@bitlab/session-tools-core';
...
export function getPathHint(targetPath: string, plansFolderPath: string, dataFolderPath?: string): string | null {
  ...
  // Case: Writing outside the configured Bitlab data directory entirely
...
export function shouldAllowToolInMode(
  ...
  if (toolName.startsWith('mcp__')) {
    ...
    if (toolName.startsWith('mcp__bitlab-docs__')) {
      return { allowed: true };
    }
