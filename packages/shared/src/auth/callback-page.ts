...
import { BITLAB_MARK_IMAGE_DATA_URI } from '../branding.ts';
...
<body>
  <div class="content">
    <img class="logo" src="${BITLAB_MARK_IMAGE_DATA_URI}" alt="Bitlab" />
    <div class="card">
      <div class="status">${statusMessage}</div>
    </div>
    <div class="hint">${isSuccess ? 'You can now return to the application.' : 'Please close this window and try again.'}</div>
    ${deeplinkUrl ? `<a href="${deeplinkUrl}" class="return-link">Bitlab</a>` : ''}
  </div>
