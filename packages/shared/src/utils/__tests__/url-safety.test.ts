...
describe('classifyExternalUrl — internal deep links', () => {
  it('classifies bitlab:// as internal-deeplink', () => {
    expect(classifyExternalUrl('bitlab://settings').kind).toBe('internal-deeplink')
  })
...
describe('formatBlockedUrlError', () => {
  ...
  it('returns an empty string for non-dangerous classifications', () => {
    ...
    expect(formatBlockedUrlError(classifyExternalUrl('bitlab://settings'))).toBe('')
  })
})
...
describe('isSafeExternalUrl', () => {
  ...
  it('returns false for internal deep links', () => {
    expect(isSafeExternalUrl('bitlab://settings')).toBe(false)
  })
