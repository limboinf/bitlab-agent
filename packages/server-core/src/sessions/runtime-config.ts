import type { AgentProvider, LlmAuthType } from '@bitlab/shared/agent/backend'
import { isCompatProvider, modelSupportsImages, type LlmConnection } from '@bitlab/shared/config'
import type { FileAttachment } from '@bitlab/shared/protocol'
