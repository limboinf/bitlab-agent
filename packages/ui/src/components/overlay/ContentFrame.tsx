    ...
    <div className="flex px-6">
      ...
      >
        ...
        {/* Main card — grows to fit content, no internal scrolling.
            The floor only keeps the frame from collapsing onto its title bar; a
            four-line command result should read as a small card, not as one
            screen of padding. */}
        <div className="flex flex-col rounded-2xl overflow-hidden backdrop-blur-sm shadow-strong bg-background min-h-[120px]">
          {/* Title bar */}
